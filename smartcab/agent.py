...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.qtable_temp = dict((i, 0.0) for i in self.valid_actions)

        for state_tuple in itertools.product(*self.state_space):
            self.Q[state_tuple] = self.qtable_temp.copy()
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            self.epsilon = 0 # no random exploration
    ...
    def createQ(self, state):
        ...
        if not state in self.Q:
            self.Q[state] = self.qtable_temp.copy()
    ...
    def choose_action(self, state):
        ...
        if not self.learning or random.random() <= self.epsilon:
            ...
            maxQ, tied_actions = self.get_maxQ(state)
